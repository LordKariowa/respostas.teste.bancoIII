...
--
-- Host: 127.0.0.1
-- Generation Time: 06-Set-2019 às 01:33
...
INSERT INTO `carros` (`id`, `modelo`, `preço`, `ano`, `fabricante`) VALUES
...
SELECT * FROM carros WHERE preço BETWEEN 30.000 and 50.000;
SELECT * FROM carros ORDER BY preço DESC LIMIT 5;
SELECT * FROM carros WHERE preço < 30.00 and fabricante LIKE '%FIAT';
SELECT modelo from carros where ano >= '2015';
SELECT preço, ano FROM carros WHERE fabricante LIKE '%renault' ORDER BY preço DESC LIMIT 3;
UPDATE carros SET preço = 14.00 WHERE modelo = 'logan' and ano = '2019';
